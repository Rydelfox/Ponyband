...
extern void take_hit(int dam, const char *kb_str, int source);
extern void acid_dam(int dam, const char *kb_str, int source);
extern void elec_dam(int dam, const char *kb_str, int source);
extern void fire_dam(int dam, const char *kb_str, int source);
extern void cold_dam(int dam, const char *kb_str, int source);
extern void pois_dam(int dam, const char *kb_str, int source);
