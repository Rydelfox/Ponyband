...
static timed_effect effects[] = {
	...
	{"You guard against all attacks", "You are no longer guarded.",
	 NULL, NULL,
	 0, PU_BONUS, MSG_INVULN},
    ...
    {"You raise a protective shield of mana!", "Your shield fades.",
     "Your mana shield grows stronger.", "Your mana shield waivers.",
     0, 0, MSG_SHIELD},
    {"You begin to focus your magic.", "Your focus breaks.",
     "You focus sharpens.", "You begin to lose focus.",
     0, 0, MSG_GENERIC},
    {"Your movements feel uninhibited.", "Your movements return to normal.",
     NULL, NULL, 0, 0, MSG_BOLD},
    {"Your feet become rooted to the ground!", "You manage to free your feet.",
     "The hold on your feet strengthens!", "The hold on your feet weakens.",
     0, 0, MSG_SLOW},
    {"Your strength feels protected!", "Your strength is no longer protected.",
     NULL, NULL, 0, 0, MSG_BLESSED},
    {"Your dexterity feels protected!", "Your dexterity is no longer protected.",
     NULL, NULL, 0, 0, MSG_BLESSED},
    {"Your constitution feels protected!", "Your constitution is no longer protected.",
     NULL, NULL, 0, 0, MSG_BLESSED},
    {"Your intelligence feels protected!", "Your intelligence is no longer protected.",
     NULL, NULL, 0, 0, MSG_BLESSED},
    {"Your wisdom feels protected!", "Your wisdom is no longer protected.",
     NULL, NULL, 0, 0, MSG_BLESSED},
    {"Your charisma feels protected!", "Your charisma is no longer protected.",
     NULL, NULL, 0, 0, MSG_BLESSED},
